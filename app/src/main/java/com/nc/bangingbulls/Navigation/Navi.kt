...
import com.nc.bangingbulls.Authentication.V.IntroCardScreen
...
fun Navi(navController: NavHostController) {
    ...
    val factory = AuthViewModelFactory(FirebaseFirestore.getInstance(), FirebaseAuth.getInstance())
    ...
    NavHost(navController = navController, startDestination = "SplashScreen") {
        ...
        composable("IntroCardScreen") { IntroCardScreen(navController = navController) }

        composable("HomeScreen") { HomeScreen(navController, authViewModel, userViewModel) }

        composable("UsernameInputScreen") { UsernameInputScreen(navController, authViewModel) }
    }
}
